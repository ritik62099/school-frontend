...
const EditStudent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ Validate transport fee if transport is enabled
    if (formData.transport && !formData.transportFee) {
      setError('Please enter transport fee amount.');
      setSubmitting(false);
      return;
    }
...
/>
          ...
          {/* ✅ Show Transport Fee field only when transport is enabled */}
          {formData.transport && (
            <InputField
              label="Transport Fee"
              name="transportFee"
