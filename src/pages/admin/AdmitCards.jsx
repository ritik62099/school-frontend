...
//       <html>
//         <head><title>Admit Card - ${student.name}</title></head>
//         <body style="font-family: Arial; text-align: center; padding: 20px;">
//           <h2 style="color: #2c3e50;">Admit Card</h2>
//           <div style="border: 2px solid #3498db; padding: 20px; max-width: 500px; margin: 0 auto; border-radius: 10px;">
//             <h3>${student.name}</h3>
      ...
      <head>
        ...
        <style>
          @media print {
            ...
            /* Container for one 1/3-height card */
            .card-container {
              width: 210mm; /* A4 width */
              height: calc(239mm / 3); /* Exactly 1/3 of A4 height */
      ...
      <head>
        ...
        <style>
          @media print {
            ...
            body {
              margin: 0;
              padding: 8mm; /* ~8mm safe margin on all sides */
              font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
              background: white;
            }
            .page {
            ...
            /* Ensure exactly 3 cards per page — no extra spacing */
            ...
            .session { color: #27ae60; font-size: 16px; font-weight: 600; margin: 1px 0;display: flex;
               justify-content: center; }
            .admit-title {
              background: #34495e;
              color: white;
